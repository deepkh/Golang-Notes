...
class Person PROTOBUF_FINAL :
 ...
 public:
  ...
  // string hobbys = 5;
  void clear_hobbys();
  const std::string& hobbys() const;
  void set_hobbys(const std::string& value);
  void set_hobbys(std::string&& value);
  void set_hobbys(const char* value);
  void set_hobbys(const char* value, size_t size);
  std::string* mutable_hobbys();
  std::string* release_hobbys();
  void set_allocated_hobbys(std::string* hobbys);
  private:
  const std::string& _internal_hobbys() const;
  void _internal_set_hobbys(const std::string& value);
  std::string* _internal_mutable_hobbys();
  public:
...
// string hobbys = 5;
inline void Person::clear_hobbys() {
...
inline void Person::_internal_set_hobbys(const std::string& value) {
  
  hobbys_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void Person::set_hobbys(std::string&& value) {
...
inline void Person::set_hobbys(const char* value) {
  ...
  hobbys_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:addressbook.Person.hobbys)
}
inline void Person::set_hobbys(const char* value,
    size_t size) {
  
  hobbys_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:addressbook.Person.hobbys)
}
inline std::string* Person::_internal_mutable_hobbys() {
  
  return hobbys_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
